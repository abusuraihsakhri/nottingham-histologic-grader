"""
Automated Pytest for nottingham-histologic-grader Enrichment Modules.
"""
import sys
...
from enrichment import (
    ...
    NottinghamhistologicgraderEnrichmentSuite,
    enrichment_suite,
)

def test_enrichment_suite_execution():
    suite = NottinghamhistologicgraderEnrichmentSuite()
