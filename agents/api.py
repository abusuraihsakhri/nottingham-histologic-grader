...
app = FastAPI(
    title="Nottingham Histologic Grader API",
...
@app.get("/health")
def health():
    return {"status": "HEALTHY", "service": "nottingham-histologic-grader", "domain": "Radiology & Neuroimaging Systems", "standard": "ACR RADS / Fleischner Society / ASPECTS Guidelines", "version": "3.0.0-ENTERPRISE"}
